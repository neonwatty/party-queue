    ...
    <div className="container-mobile bg-gradient-party flex flex-col px-6 py-8 safe-area-bottom relative">
      ...
      <div className="flex-1 flex flex-col justify-center relative z-10">
        <div className="animate-fade-in-up opacity-0">
          ...
          <h1 className="text-5xl font-bold leading-tight mb-4 text-center" style={{ fontFamily: 'var(--font-display)' }}>
          ...
          <div className="space-y-4">
            ...
            <Link
              href="/join"
              className="btn btn-secondary w-full text-lg flex items-center justify-center gap-3"
            >
              <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2">
